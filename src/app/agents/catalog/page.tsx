  ...
  return (
    <div className="space-y-6 animate-in">
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <SummaryCard icon={<Sparkles size={16} />} label="GitHub-Vorlagen" value={String(agents.filter((agent) => agent.sourceRepo).length)} />
      </div>
              ...
              <div className="panel-body space-y-4">
                ...
                <div className="flex items-center justify-between gap-3 flex-wrap border-t border-border/60 pt-3">
                  <div className="text-xs text-muted-foreground">
                    Vorlage: {draft.inspiredBy || 'individuell'}{draft.sourceRepo ? ` · ${draft.sourceRepo}` : ''}
                  </div>
                  <button
                    type="button"
